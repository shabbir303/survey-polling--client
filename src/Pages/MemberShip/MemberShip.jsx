        ...
        <div className="">
            ...
            <div className="w-full max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                ...
                <Link to='/Dashboard/payments'>
                    <button disabled={isAdmin||isSurveyor|| isProUser } onClick={handleMemberShip}
                        type="button" className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 disabled:bg-gray-400 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Buy the Membership</button>
                </Link>
            </div>
